...
export const defaults: PricesData = {
  ...
  "table-standard-chair-set":          { label: "Rectangular Table & Standard Chair Set", price: "16",  unit: "each" },
  "table-premium-chair-set":           { label: "Table & Premium Chair Set",              price: "18",  unit: "each" },
  "round-table-8-premium-chairs":      { label: "Round Table & 8 Premium Chair Set",      price: "36",  unit: "each" },
