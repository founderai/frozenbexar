...
const DEFAULT_CATALOG: CatalogItem[] = [
  ...
  { id: "table-premium-chair-set",        name: "Table & Premium Chair Set",              sub: "6ft table with premium padded chairs",     color: "#e81ccd", icon: "Armchair", image: "/rectangular-premium.png",  visible: true },
  { id: "table-standard-chair-set",       name: "Rectangular Table & Standard Chair Set", sub: "6ft table with standard white chairs",     color: "#00e64d", icon: "Armchair", image: "/rectangular-standard.png", visible: true },
  ...
  { id: "round-table-8-chairs",           name: "Round Table & Standard Chair Set",       sub: "5' round table & 8 standard white chairs", color: "#00e64d", icon: "Table2",   image: "/circle-standard.png",      visible: true },
  { id: "round-table-8-premium-chairs",   name: "Round Table & 8 Premium Chair Set",      sub: "5' round table & 8 premium white chairs",  color: "#e81ccd", icon: "Table2",   image: "/circle-premium.png",       visible: true },
...
const CATALOG_GROUPS = [
  ...
  { label: "Tables & Chair Sets", ids: ["table", "table-standard-chair-set", "table-premium-chair-set", "round-table", "round-table-8-chairs", "round-table-8-premium-chairs", "cocktail-tables"] },
