  ...
  return (
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        {/* Reviews + Follow Us */}
        <div className="absolute top-4 right-4 sm:top-6 sm:right-8 z-10 flex items-start gap-4 sm:gap-6">
          <a
            href="https://share.google/XghIkHYp65fcUl2kD"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="See Frozen Bexar's 5-star Google rating"
            className="group flex flex-col items-center"
          >
            <p className="text-xs sm:text-sm font-black uppercase tracking-[0.1em] text-white mb-1 whitespace-nowrap">
              5 Star Rated
            </p>
            <div className="flex gap-0.5 mb-2" aria-hidden="true">
              {[1, 2, 3, 4, 5].map((star) => (
                <Star key={star} size={11} className="text-[#fbbc05] fill-[#fbbc05]" />
              ))}
            </div>
            <span className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-white flex items-center justify-center shadow-[0_0_24px_rgba(66,133,244,0.35)] transition-all group-hover:scale-110">
          ...
          <div className="flex flex-col items-center">
            <p
              className="text-sm sm:text-base font-black uppercase tracking-[0.15em] mb-2 whitespace-nowrap"
              style={{
                background: "linear-gradient(135deg,#f58529,#dd2a7b,#e81ccd)",
                WebkitBackgroundClip: "text",
                WebkitTextFillColor: "transparent",
                filter: "drop-shadow(0 0 10px rgba(221,42,123,0.6))",
              }}
            >
              ✨ Follow Us ✨
            </p>
            <a
              ...
              className="group w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center transition-all hover:scale-110 pulse-glow"
              style={{ background: "linear-gradient(135deg,#f58529,#dd2a7b,#8134af,#515bd4)" }}
            >
              <svg width="34" height="34" viewBox="0 0 24 24" fill="white" className="transition-transform group-hover:scale-110">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-24 sm:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Text */}
          <div>
      ...
      <section className="py-20" style={{ background: "linear-gradient(135deg,#1a0015,#001a0a)" }}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 mb-8 text-lg">
            Fill out our quick quote form and we&apos;ll get back to you same day. No payment required online — just let us know what you need!
          </p>
          <Link
            href="/quote"
