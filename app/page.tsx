            ...
            <div className="flex flex-col items-center mb-6">
              ...
              <div className="flex items-center gap-6">
                <a
                  ...
                  className="group w-16 h-16 rounded-full flex items-center justify-center transition-all hover:scale-110"
                  style={{ background: "linear-gradient(135deg,#1877f2,#0d5abf)", boxShadow: "0 0 24px rgba(24,119,242,0.4)" }}
                >
                  <svg width="30" height="30" viewBox="0 0 24 24" fill="white" className="transition-transform group-hover:scale-110">
                ...
                <a
                  ...
                  className="group w-16 h-16 rounded-full flex items-center justify-center transition-all hover:scale-110"
                  style={{ background: "linear-gradient(135deg,#f58529,#dd2a7b,#8134af,#515bd4)", boxShadow: "0 0 24px rgba(221,42,123,0.4)" }}
                >
                  <svg width="30" height="30" viewBox="0 0 24 24" fill="white" className="transition-transform group-hover:scale-110">
